...
class Girls extends Component{
      ...
      setTimeout(() => {
        this.setState({
         ...
         Carouseldata:[
            {
               text:'大河峥嵘',
               img:'https://i.zhulang.com/admin/bang/2020-10-28/5f98d37d21770.jpg',
               id:''
            },
            {
               text:'万古狂尊',
               img:'https://i.zhulang.com/admin/bang/2020-10-28/5f98d36f796b8.jpg',
               id:''
            }, 
            {
               text:'武极神王',
               img:'https://i.zhulang.com/admin/bang/2020-10-28/5f98d3740ed16.jpg',
               id:''
            },
         ]
        });
   ...
   render(){
      return (
         <div>
            <div className='wrap girlsWrap'>
               <div className='boyTop girlsTop'>
                  <i><LeftOutlined /></i>
                  <p><span className='boy' 
                  onClick={()=>{ this.props.history.push('/boy');}}>男生</span>
                  <span className='girls'>女生</span></p>
                  <i className='boyI'><HomeOutlined onClick={this.go} /></i>
               
               </div>
               <div className='boyMain girlsMain'>
                  ...
                  <div className='newBook'>
                     ...
                     <ul>
                        <li>
                              <div className='pic1'><i>1</i><b></b><img src="https://i.zhulang.com/xxs_book_cover/image/54/57/545721_x160.jpg" alt=""/></div>
                              <div>
                                 <h4>老爸老妈</h4>
                                 <span>散仙 | 现实百态</span>
                                 <p>作品人物老爸和老妈是50年代的知识分子，经历了毕业、分配 工作、结婚生子、子女成家、退休享受晚年，中间有欢乐，有痛苦，当今社会金钱与亲情的碰撞，人与人之间的变化，现实生动展现了人生观、事业观和家庭观，值得人们深思。
